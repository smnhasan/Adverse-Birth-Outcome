...
round(svytable(~Pre_Birth,design=design1))
prop.table(svytable(~Pre_Birth,design=design1))*100

round(svytable(~v025+Pre_Birth,design=design1)) #type of place of residence
round(svytable(~v025,design=design1))
prop.table(svytable(~v025,design=design1))*100
prop.table(svytable(~v025+Pre_Birth,design=design1), margin=1)*100
svychisq(~v025+Pre_Birth,design=design1,data=kr)  #sig

logit1 <- (svyglm(Pre_Birth~v025, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
...
round(svytable(~v101+Pre_Birth,design=design1))  #division
round(svytable(~v101,design=design1))
prop.table(svytable(~v101,design=design1))*100
prop.table(svytable(~v101+Pre_Birth,design=design1), margin=1)*100
svychisq(~v101+Pre_Birth,design=design1,data=kr) #sig

logit1 <- (svyglm(Pre_Birth~v101, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1) #insig
...
round(svytable(~media+Pre_Birth,design=design1)) #media
round(svytable(~media,design=design1))
prop.table(svytable(~media,design=design1))*100
prop.table(svytable(~media+Pre_Birth,design=design1), margin=1)*100
svychisq(~media+Pre_Birth,design=design1,data=kr)  #insig

logit1 <- (svyglm(Pre_Birth~media, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1) #sig
...
round(svytable(~v113+Pre_Birth,design=design1)) #source of drinking water
round(svytable(~v113,design=design1))
prop.table(svytable(~v113,design=design1))*100
prop.table(svytable(~v113+Pre_Birth,design=design1), margin=1)*100
svychisq(~v113+Pre_Birth,design=design1,data=kr)  #insig

logit1 <- (svyglm(Pre_Birth~v113, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1) #insig
...
round(svytable(~v116+Pre_Birth,design=design1)) #Toilet Service
round(svytable(~v116,design=design1))
prop.table(svytable(~v116,design=design1))*100
prop.table(svytable(~v116+Pre_Birth,design=design1), margin=1)*100
svychisq(~v116+Pre_Birth,design=design1,data=kr) #insig

logit1 <- (svyglm(Pre_Birth~v116, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1) #sig
...
round(svytable(~v161+Pre_Birth,design=design1)) #fuel
round(svytable(~v161,design=design1))
prop.table(svytable(~v161,design=design1))*100
prop.table(svytable(~v161+Pre_Birth,design=design1), margin=1)*100
svychisq(~v161+Pre_Birth,design=design1,data=kr) #insig

logit1 <- (svyglm(Pre_Birth~v161, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1) #sig
model.or <- cbind(exp(coef(logit1)),exp(confint(logit1)))
colnames(model.or) <- c('odds ratio','ci(2.5%)','ci(97.5%)')
model.or #for odds ratio and ci

round(svytable(~v190+Pre_Birth,design=design1))  #wealth index combined
round(svytable(~v190,design=design1))
prop.table(svytable(~v190,design=design1))*100
prop.table(svytable(~v190+Pre_Birth,design=design1), margin=1)*100
svychisq(~v190+Pre_Birth,design=design1,data=kr) #insig

logit1 <- (svyglm(Pre_Birth~v190, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1) #sig
...
round(svytable(~v119+Pre_Birth,design=design1)) #electricity
round(svytable(~v119,design=design1))
prop.table(svytable(~v119,design=design1))*100
prop.table(svytable(~v119+Pre_Birth,design=design1), margin=1)*100
svychisq(~v119+Pre_Birth,design=design1,data=kr) #insig

logit1 <- (svyglm(Pre_Birth~v119, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1) #sig
...
round(svytable(~floor+Pre_Birth,design=design1)) #floor
round(svytable(~floor,design=design1))
prop.table(svytable(~floor,design=design1))*100
prop.table(svytable(~floor+Pre_Birth,design=design1), margin=1)*100
svychisq(~floor+Pre_Birth,design=design1,data=kr) #sig

logit1 <- (svyglm(Pre_Birth~floor, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1) #sig
...
round(svytable(~roof+Pre_Birth,design=design1)) #roof
round(svytable(~roof,design=design1))
prop.table(svytable(~roof,design=design1))*100
prop.table(svytable(~roof+Pre_Birth,design=design1), margin=1)*100
svychisq(~roof+Pre_Birth,design=design1,data=kr) #insig

logit1 <- (svyglm(Pre_Birth~roof, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1) #insig
...
round(svytable(~wall+Pre_Birth,design=design1)) #wall
round(svytable(~wall,design=design1))
prop.table(svytable(~wall,design=design1))*100
prop.table(svytable(~wall+Pre_Birth,design=design1), margin=1)*100
svychisq(~wall+Pre_Birth,design=design1,data=kr) #insig

logit1 <- (svyglm(Pre_Birth~wall, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1) #insig
...
round(svytable(~hhmem+Pre_Birth,design=design1)) #hhmember
round(svytable(~hhmem,design=design1))
prop.table(svytable(~hhmem,design=design1))*100
prop.table(svytable(~hhmem+Pre_Birth,design=design1), margin=1)*100
svychisq(~hhmem+Pre_Birth,design=design1,data=kr) #insig


logit1 <- (svyglm(Pre_Birth~hhmem, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1) #insig
...
round(svytable(~h10+Pre_Birth,design=design1)) #ever had vaccination
round(svytable(~h10,design=design1))
prop.table(svytable(~h10,design=design1))*100
prop.table(svytable(~h10+Pre_Birth,design=design1), margin=1)*100
svychisq(~h10+Pre_Birth,design=design1,data=kr)  #insig

logit1 <- (svyglm(Pre_Birth~h10, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1) #sig
...
round(svytable(~v013+Pre_Birth,design=design1)) #age in 5-year groups
round(svytable(~v013,design=design1))
prop.table(svytable(~v013,design=design1))*100
prop.table(svytable(~v013+Pre_Birth,design=design1), margin=1)*100
svychisq(~v013+Pre_Birth,design=design1,data=kr)  #insig

logit1 <- (svyglm(Pre_Birth~v013, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1) #sig
...
round(svytable(~v106+Pre_Birth,design=design1)) # mother Education
round(svytable(~v106,design=design1))
prop.table(svytable(~v106,design=design1))*100
prop.table(svytable(~v106+Pre_Birth,design=design1), margin=1)*100
svychisq(~v106+Pre_Birth,design=design1,data=kr)  #insig

logit1 <- (svyglm(Pre_Birth~v106, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1) #sig
...
round(svytable(~bmi+Pre_Birth,design=design1))  #mothers bmi
round(svytable(~bmi,design=design1))
prop.table(svytable(~bmi,design=design1))*100
prop.table(svytable(~bmi+Pre_Birth,design=design1), margin=1)*100
svychisq(~bmi+Pre_Birth,design=design1,data=kr) #insig

logit1 <- (svyglm(Pre_Birth~bmi, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1) #sig
...
round(svytable(~v218+Pre_Birth,design=design1)) #number of living children
round(svytable(~v218,design=design1))
prop.table(svytable(~v218,design=design1))*100
prop.table(svytable(~v218+Pre_Birth,design=design1), margin=1)*100
svychisq(~v218+Pre_Birth,design=design1,data=kr)  #insig

logit1 <- (svyglm(Pre_Birth~v218, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1) #sig
...
round(svytable(~rocu+Pre_Birth,design=design1))
round(svytable(~rocu,design=design1))
prop.table(svytable(~rocu,design=design1))*100
prop.table(svytable(~rocu+Pre_Birth,design=design1), margin=1)*100
svychisq(~rocu+Pre_Birth,design=design1,data=kr) #insig

logit1 <- (svyglm(Pre_Birth~rocu, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1) #sig
...
round(svytable(~rworkfor+Pre_Birth,design=design1))
round(svytable(~rworkfor,design=design1))
prop.table(svytable(~rworkfor,design=design1))*100
prop.table(svytable(~rworkfor+Pre_Birth,design=design1), margin=1)*100
svychisq(~rworkfor+Pre_Birth,design=design1,data=kr) #insig

logit1 <- (svyglm(Pre_Birth~rworkfor, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1) #sig
...
round(svytable(~hocu+Pre_Birth,design=design1))
round(svytable(~hocu,design=design1))
prop.table(svytable(~hocu,design=design1))*100
prop.table(svytable(~hocu+Pre_Birth,design=design1), margin=1)*100
svychisq(~hocu+Pre_Birth,design=design1,data=kr) #insig

logit1 <- (svyglm(Pre_Birth~hocu, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1) #insig
...
round(svytable(~hedu+Pre_Birth,design=design1))
round(svytable(~hedu,design=design1))
prop.table(svytable(~hedu,design=design1))*100
prop.table(svytable(~hedu+Pre_Birth,design=design1), margin=1)*100
svychisq(~hedu+Pre_Birth,design=design1,data=kr) #insig

logit1 <- (svyglm(Pre_Birth~hedu, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1) #sig
...
round(svytable(~s107a+Pre_Birth,design=design1)) #HH education type
round(svytable(~s107a,design=design1))
prop.table(svytable(~s107a,design=design1))*100
prop.table(svytable(~s107a+Pre_Birth,design=design1), margin=1)*100
svychisq(~s107a+Pre_Birth,design=design1,data=kr) #insig 

logit1 <- (svyglm(Pre_Birth~s107a, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1) #sig
...
round(svytable(~age+Pre_Birth,design=design1)) #child age
round(svytable(~age,design=design1))
prop.table(svytable(~age,design=design1))*100
prop.table(svytable(~age+Pre_Birth,design=design1), margin=1)*100
svychisq(~age+Pre_Birth,design=design1,data=kr) #insig

logit1 <- (svyglm(Pre_Birth~age, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1) #sig
...
round(svytable(~b4+Pre_Birth,design=design1)) #sex of child
round(svytable(~b4,design=design1))
prop.table(svytable(~b4,design=design1))*100
prop.table(svytable(~b4+Pre_Birth,design=design1), margin=1)*100
svychisq(~b4+Pre_Birth,design=design1,data=kr)  #insig

logit1 <- (svyglm(Pre_Birth~b4, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1) #sig
...
round(svytable(~bord+Pre_Birth,design=design1)) #birth order
round(svytable(~bord,design=design1))
prop.table(svytable(~bord,design=design1))*100
prop.table(svytable(~bord+Pre_Birth,design=design1), margin=1)*100
svychisq(~bord+Pre_Birth,design=design1,data=kr)   #insig

logit1 <- (svyglm(Pre_Birth~bord, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1)  #insig
...
round(svytable(~m15+Pre_Birth,design=design1)) #place of delivery
round(svytable(~m15,design=design1))
prop.table(svytable(~m15,design=design1))*100
prop.table(svytable(~m15+Pre_Birth,design=design1), margin=1)*100
svychisq(~m15+Pre_Birth,design=design1,data=kr)  #insig

logit1 <- (svyglm(Pre_Birth~m15, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1)  #insig
...
###
round(svytable(~bw+Pre_Birth,design=design1)) #birth weight
round(svytable(~bw,design=design1))
prop.table(svytable(~bw,design=design1))*100
prop.table(svytable(~bw+Pre_Birth,design=design1), margin=1)*100
svychisq(~bw+Pre_Birth,design=design1,data=kr) #insig

logit1 <- (svyglm(Pre_Birth~bw, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1)  #insig
...
round(svytable(~m17+Pre_Birth,design=design1)) #C-section
round(svytable(~m17,design=design1))
prop.table(svytable(~m17,design=design1))*100
prop.table(svytable(~m17+Pre_Birth,design=design1), margin=1)*100
svychisq(~m17+Pre_Birth,design=design1,data=kr) #insig

logit1 <- (svyglm(Pre_Birth~m17, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1)  #insig
...
round(svytable(~season+Pre_Birth,design=design1)) #season
round(svytable(~season,design=design1))
prop.table(svytable(~season,design=design1))*100
prop.table(svytable(~season+Pre_Birth,design=design1), margin=1)*100
svychisq(~season+Pre_Birth,design=design1,data=kr)   #sig

logit1 <- (svyglm(Pre_Birth~season, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1) #insig
...
round(svytable(~h43+Pre_Birth,design=design1))  #drugs for intestinal parasites in last 6 months
round(svytable(~h43,design=design1))
prop.table(svytable(~h43,design=design1))*100
prop.table(svytable(~h43+Pre_Birth,design=design1), margin=1)*100
svychisq(~h43+Pre_Birth,design=design1,data=kr) #insig

logit1 <- (svyglm(Pre_Birth~h43, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1) #sig
...
round(svytable(~va+Pre_Birth,design=design1)) #vitamin a
round(svytable(~va,design=design1))
prop.table(svytable(~va,design=design1))*100
prop.table(svytable(~va+Pre_Birth,design=design1), margin=1)*100
svychisq(~va+Pre_Birth,design=design1,data=kr) #insig

logit1 <- (svyglm(Pre_Birth~va, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1)  #insig
...
round(svytable(~stunting+Pre_Birth,design=design1))
round(svytable(~stunting,design=design1))
prop.table(svytable(~stunting,design=design1))*100
prop.table(svytable(~stunting+Pre_Birth,design=design1), margin=1)*100
svychisq(~stunting+Pre_Birth,design=design1,data=kr) #insig

logit1 <- (svyglm(Pre_Birth~stunting, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1)  #insig
...
round(svytable(~wasting+Pre_Birth,design=design1))
round(svytable(~wasting,design=design1))
prop.table(svytable(~wasting,design=design1))*100
prop.table(svytable(~wasting+Pre_Birth,design=design1), margin=1)*100
svychisq(~wasting+Pre_Birth,design=design1,data=kr) #insig

logit1 <- (svyglm(Pre_Birth~wasting, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1)  #insig
...
round(svytable(~uw+Pre_Birth,design=design1))
round(svytable(~uw,design=design1))
prop.table(svytable(~uw,design=design1))*100
prop.table(svytable(~uw+Pre_Birth,design=design1), margin=1)*100
svychisq(~uw+Pre_Birth,design=design1,data=kr) #insig

logit1 <- (svyglm(Pre_Birth~uw, family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1)  #insig
...
####Pre_Birth~ v025+ v101+ media+ v113+ v116+ v161+ v190+ v119+ floor+ roof+ wall+ hhmem+ h10+ v013+ v106 + bmi + v218 + rocu + rworkfor+hocu + hedu+ s107a+ age+ b4+ bord+ m15 + m17 + season+ h43+ va+ stunting + wasting
options(scipen=999)
logit1 <- (svyglm(Pre_Birth ~ v025+ media+ v113+ v116+ v161+ v119+ hhmem+ h10+ v106 + rworkfor+
                     s107a+ b4+ bord+ m15 + m17 + h43+ va+ stunting + wasting , family=quasibinomial(link=logit), data=kr,design=design1, na.action = na.omit))
summary(logit1) #sig
vif(logit1)


model.or <- round(cbind(exp(coef(logit1)),exp(confint(logit1))),2)
colnames(model.or) <- c('odds ratio','ci(2.5%)','ci(97.5%)')
model.or #for odds ratio and ci


#multivPre_Birthable logistic
...
# #graph1
# 
# q_2 <- svytable(~kr$Pre_Birth+kr$v106+kr$v025,design1)
# 
# q_2 <- as.data.frame(q_2)
# names(q_2) <- c('Pre_Birth','edu','res','freq')
# q_2 <- q_2[which(q_2$Pre_Birth=='yes'),]
# 
...
Pre_Birth <- read.csv("E:\\Study\\ResearchProject\\Pre_Birth_BioMass\\Pre_Birth.csv")

q_1$prev <- ifelse(q_1$id==0,Pre_Birth$Pre_Birth[1],
                   ifelse(q_1$id==1,Pre_Birth$Pre_Birth[2],
                          ifelse(q_1$id==2,Pre_Birth$Pre_Birth[3],
                                 ifelse(q_1$id==3,Pre_Birth$Pre_Birth[4],
                                        ifelse(q_1$id==4,Pre_Birth$Pre_Birth[5],
                                               ifelse(q_1$id==5,Pre_Birth$Pre_Birth[6],
                                                      ifelse(q_1$id==6,Pre_Birth$Pre_Birth[7],Pre_Birth$Pre_Birth[8])))))))


centroids.df <- as.data.frame(coordinates(q))
names(centroids.df) <- c("Longitude", "Latitude")
centroids.df$name <- c('    BPre_Birthsal',
                       'Chittagong\n',
                       'Dhaka','Khulna\n',
                       'Mymensingh\n',
                       'Rajshahi',
...
x <- ggplot(q_1, aes(x=long, y=lat)) +geom_polygon(aes(group=group,fill=prev),colour= "lightgrey")+coord_map()+
  ...
  scale_fill_distiller(name='Pre_Birth (%)',palette ="YlOrRd", direction=1)+
...
Pre_Birth <- read.csv("E:\\Study\\ResearchProject\\Pre_Birth_BioMass\\BF.csv")
...
# df2 <- data.frame(Pre_Birth=rep(c("Yes", "No"), each=7),
...
# head(df2)
# 
# ggplot(data=df2, aes(x=, y=Percentage, fill=Pre_Birth)) +
...
x <-ggplot(data=df, aes(x=reorder(dose, -len), y=len)) +
  ...
  theme_minimal()+
  xlab("Cooking fuel") + ylab("Symptoms of Pre_Birth (%)") + theme(legend.title = element_text(color = "Black", size = 18),
                                                             legend.text = element_text(color = "Black", size = 18),
